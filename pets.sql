...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 01, 2022 at 07:13 PM
...
INSERT INTO `orders` (`order_id`, `date_created`, `date_shipped`, `user_id`, `status`, `shipping_id`) VALUES
(1013, '2022-11-16 18:01:44', '2022-11-23 18:01:44', 69, 'Awaiting Delivery', 30),
(1014, '2022-11-16 18:04:36', '2022-11-23 18:04:36', 69, 'Awaiting Delivery', 31),
(1015, '2022-11-16 19:39:43', '2022-11-23 19:39:43', 4, 'Awaiting Delivery', 32),
(1017, '2022-11-17 12:42:09', '2022-11-24 12:42:09', 1, 'Awaiting Delivery', 34);
...
INSERT INTO `order_details` (`order_id`, `pet_id`, `unit_cost`) VALUES
(1013, 1297, 15.5),
(1013, 1388, 12.5),
(1014, 1300, 15.5),
(1015, 1298, 15.5),
...
(1292, 1, 11, 'Rusty', 'Female', 3, 'Medium', 'Chestnut', 'Hi we are looking for someone who could take care of this pet. For more information contact +32498123456', 'Angelica', '2022-09-21 14:39:36', 6, 0),
(1293, 44, 67, 'Molly', 'Male', 10, 'Small', 'Light', 'Well hello there! My name is Slate! I’m a very handsome boy that is looking for a home! I am currently at Happy Hound Doggie Daycare having a BLAST! I get to go into playgroup everyday and play with many dogs! it’s seriously the BEST! I’m not sure what my', 'Duck', '2022-09-21 14:39:36', 6, 1),
(1294, 28, 8, 'Josie', 'Female', 6, 'Medium', 'Silver', 'Highly energetic and friendly Ella needs lots of play time! Super sweet and goofy, but not a beginner dog.Her favorite activities are:- running- tug games- chewing heavy duty rubber toys- napping with her peopleShe wants to be involved in whatever', 'Cider with golden cheese', '2022-09-21 14:39:36', 5, 0),
(1295, 33, 42, 'Peppy', 'Female', 9, 'Small', 'Beige', 'Lucy was born Jan 2021. We adopted her from a rescue at 3 months. She\'s current on all vaccines. She is the sweeeeetest dog you\'ll ever meet. Zero aggression but barks at strange sounds/people at night. Lucy is very treat-motivated. She knows sit, down, s', 'Canola Oil', '2022-09-21 14:39:36', 4, 0),
(1296, 44, 96, 'Amigo', 'Female', 6, 'Small', 'Red', 'Ollie is a wonderful dog with lots of energy. He loves to swim and loves to play fetch. He really loves affection. Unfortunately we can no longer provide him with what he needs as we have a new born and cannot provide him with the life he needs anymore. I', 'Cannellini Beans', '2022-09-21 14:39:36', 6, 1),
(1297, 44, 105, 'Chi Chi', 'Male', 5, 'Small', 'Gold', 'Lookit this guy. Such a lovable dork. Milton is a leggy American Bully, full of good fun, super affectionate and in love with people. Like, wants to follow you everywhere and gaze into your eyes affectionate. He\'s just over 1yo, is house trained now (uses', 'Chocolate', '2022-09-21 14:39:36', 7, 1),
(1298, 4, 108, 'Booker', 'Male', 9, 'Medium', 'Black', 'Ace is a puppy acquired from a litter of a friend that I know. He is an extremely friendly dog and unfortunately has too much energy for us. He has never been aggressive but he does like to play rough/play bite. He gets along with other dogs that can matc', 'Cumin', '2022-09-21 14:39:36', 7, 1),
(1299, 60, 20, 'Earl', 'Female', 7, 'Small', 'Brown', 'I acquired my pet from the next door crack house around the year 2015. She was 4 months at the time and pooping worms. Siblings and I took her on park strolls, dog park, grooming services, vaccines at spca, etc. I moved out and became a mother so my atten', 'Spearmint', '2022-09-21 14:39:36', 5, 0),
...
(1346, 1, 86, 'Tuck', 'Male', 5, 'Medium', 'Darka', 'Hi we are looking for someone who could take care of this pet. For more information contact +32498123456', 'Peas', '2022-09-21 14:39:36', 5, 0),
...
(1352, 4, 7, 'Gavin', 'Male', 6, 'Small', 'Orange', 'Hi! My name is Sweeney, and I am the goodest boy ever, can\'t you tell?!\n\nI\'m only 6 months old, but I\'ve seen and been through a lot in my short life. My siblings and I found ourselves malnourished in a Texas shelter with parvo and coccidia at about 6 wee', 'Cumin', '2022-09-21 14:39:36', 6, 1),
...
(1370, 1, 97, 'Paco', 'Male', 3, 'Medium', 'Rust', 'Hi we are looking for someone who could take care of this pet. For more information contact +32498123456', 'Cappuccino Latte', '2022-09-21 14:39:36', 5, 1),
...
INSERT INTO `shipping_info` (`shipping_id`, `shipping_type`, `shipping_cost`, `shipping_region_id`) VALUES
(30, 'BusinessWeek', 1.24, 1222),
(31, 'BusinessWeek', 0.62, 1222),
(32, 'BusinessWeek', 0.62, 2800),
(33, 'BusinessWeek', 0, 2800),
(34, 'BusinessWeek', 0.62, 2800);
...
--
ALTER TABLE `ads`
  MODIFY `id` mediumint(8) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=531;
...
--
ALTER TABLE `orders`
  MODIFY `order_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1018;
